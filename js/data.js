      ...
      children: [
        ...
        },
        {
          ...
          result: {
            ...
            icon: 'fa-piggy-bank',
            description: 'Retirement Services assists OCPS employees with Florida Retirement System (FRS) information, retirement planning, DROP program details, and transition support.',
            contacts: [
              { role: 'Main Line', info: '407-317-3200', type: 'phone' },
              { role: 'Website', info: 'ocps.net/retirement', type: 'link', url: 'https://www.ocps.net/retirement-services' }
            ],
      ...
      children: [
        ...
        },
        {
          ...
          result: {
            ...
            icon: 'fa-search-dollar',
            description: 'Internal Audit provides independent, objective assurance and consulting services to improve operations, reviewing financial, compliance, and operational matters across the district.',
            contacts: [
              { role: 'Main Line', info: '407-317-3200', type: 'phone' },
              { role: 'Website', info: 'ocps.net/internal-audit', type: 'link', url: 'https://www.ocps.net/internal-audit' }
            ],
